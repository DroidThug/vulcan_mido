 ...
 */ bool use_spi_crc = 0; EXPORT_SYMBOL(use_spi_crc); 
module_param_named(crc, use_spi_crc, bool, 0644); /* MODULE_PARM_DESC( * 
Internal function. Schedule delayed work in the MMC work queue.
	crc, */ static int mmc_schedule_delayed_work(struct delayed_work 
*work,
	"Enable/disable CRC checking");				     unsigned long delay)
{
